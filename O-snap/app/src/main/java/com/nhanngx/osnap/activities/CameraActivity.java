...
public class CameraActivity extends FragmentActivity {
    ...
    private final Runnable mHidePart2Runnable = new Runnable() {
        ...
        public void run() {
            ...
            mFragmentContentView.setSystemUiVisibility(View.SYSTEM_UI_FLAG_LOW_PROFILE
...
//        mControlsView = findViewById(R.id.fullscreen_content_controls);
        ...
        mFragmentContentView.setOnClickListener(new View.OnClickListener() {
            @Override
...
//        mHideHandler.removeCallbacks(mShowPart2Runnable);
    ...
    private void show() {
        // Show the system bar
        mFragmentContentView.setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN
                | View.SYSTEM_UI_FLAG_LAYOUT_HIDE_NAVIGATION);
        mVisible = true;
